              ...
              <Card className={classes.sectionCard}>
                <CardContent>
                  <Typography variant="h4" gutterBottom>
                    <Event style={{ marginRight: 8, verticalAlign: "middle" }} />
                    Agendamentos
                  </Typography>
                  <Typography variant="body1" paragraph>Agende mensagens e tarefas para envio automático em data/hora específicas.</Typography>
                  <Alert severity="info"><strong>Dica:</strong> Use agendamentos para followups e lembretes automáticos</Alert>
                </CardContent>
              </Card>
            </TabPanel>
...
export default AgendamentosTutorial;
