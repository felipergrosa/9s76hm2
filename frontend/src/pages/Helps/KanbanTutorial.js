              ...
              <Card className={classes.sectionCard}>
                <CardContent>
                  <Typography variant="h4" gutterBottom>
                    <ViewModule style={{ marginRight: 8, verticalAlign: "middle" }} />
                    Kanban
                  </Typography>
                  <Typography variant="body1" paragraph>Visualize e gerencie atendimentos em cards organizados por etapas do funil.</Typography>
                  <Alert severity="info"><strong>Dica:</strong> Arraste cards entre colunas para mudar status rapidamente</Alert>
                </CardContent>
              </Card>
            </TabPanel>
