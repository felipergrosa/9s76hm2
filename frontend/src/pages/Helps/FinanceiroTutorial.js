              ...
              <Card className={classes.sectionCard}>
                <CardContent>
                  <Typography variant="h4" gutterBottom>
                    <AttachMoney style={{ marginRight: 8, verticalAlign: "middle" }} />
                    Financeiro
                  </Typography>
                  <Typography variant="body1" paragraph>Controle assinaturas, pagamentos e faturamento do sistema.</Typography>
                  <Alert severity="info"><strong>Dica:</strong> Mantenha método de pagamento atualizado para evitar interrupções</Alert>
                </CardContent>
              </Card>
            </TabPanel>
...
export default FinanceiroTutorial;
