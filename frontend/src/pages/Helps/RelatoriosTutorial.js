            ...
            <TabPanel value={tabValue} index={0}>
              <Card className={classes.sectionCard}>
                <CardContent>
                  ...
                  <Typography variant="body1" paragraph>Gere relatórios detalhados de desempenho, produtividade e métricas.</Typography>
                  <Alert severity="info"><strong>Dica:</strong> Exporte relatórios em PDF ou CSV para análises externas</Alert>
                </CardContent>
              </Card>
            </TabPanel>
...
export default RelatoriosTutorial;
