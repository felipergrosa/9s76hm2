              ...
              <Card className={classes.sectionCard}>
                <CardContent>
                  <Typography variant="h4" gutterBottom>
                    <DeviceHub style={{ marginRight: 8, verticalAlign: "middle" }} />
                    FlowBuilder
                  </Typography>
                  <Typography variant="body1" paragraph>Construa fluxos de conversa automatizados com Editor visual drag-and-drop.</Typography>
                  <Alert severity="info"><strong>Dica:</strong> Teste o fluxo antes de ativar para garantir funcionamento correto</Alert>
                </CardContent>
              </Card>
            </TabPanel>
...
export default FlowBuilderTutorial;
