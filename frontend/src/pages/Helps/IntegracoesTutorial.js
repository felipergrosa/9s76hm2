            ...
            <TabPanel value={tabValue} index={0}>
              <Card className={classes.sectionCard}>
                <CardContent>
                  ...
                  <Typography variant="body1" paragraph>Integre com sistemas externos via webhooks, APIs e conectores nativos.</Typography>
                  <Alert severity="info"><strong>Dica:</strong> Teste integrações em ambiente de homologação primeiro</Alert>
                </CardContent>
              </Card>
            </TabPanel>
...
export default IntegracoesTutorial;
