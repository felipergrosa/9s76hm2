            ...
            <TabPanel value={tabValue} index={0}>
              <Card className={classes.sectionCard}>
                <CardContent>
                  ...
                  <Typography variant="body1" paragraph>Gerencie equipe, permissões, perfis de acesso e departamentos.</Typography>
                  <Alert severity="info"><strong>Dica:</strong> Use perfis de permissão para controlar acesso por função</Alert>
                </CardContent>
              </Card>
            </TabPanel>
...
export default UsuariosTutorial;
