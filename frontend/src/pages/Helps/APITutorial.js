              ...
              <Card className={classes.sectionCard}>
                <CardContent>
                  <Typography variant="h4" gutterBottom>
                    <Code style={{ marginRight: 8, verticalAlign: "middle" }} />
                    API
                  </Typography>
                  <Typography variant="body1" paragraph>Documentação completa da API REST para automações e integrações customizadas.</Typography>
                  <Alert severity="info"><strong>Dica:</strong> Use tokens de acesso seguros e nunca compartilhe credenciais</Alert>
                </CardContent>
              </Card>
            </TabPanel>
