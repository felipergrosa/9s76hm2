              ...
              <Card className={classes.sectionCard}>
                <CardContent>
                  <Typography variant="h4" gutterBottom>
                    <Label style={{ marginRight: 8, verticalAlign: "middle" }} />
                    Tags
                  </Typography>
                  <Typography variant="body1" paragraph>Organize contatos e atendimentos com etiquetas coloridas personalizadas.</Typography>
                  <Alert severity="info"><strong>Dica:</strong> Crie tags por categoria, prioridade ou status do cliente</Alert>
                </CardContent>
              </Card>
            </TabPanel>
