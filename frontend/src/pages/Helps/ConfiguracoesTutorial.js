            ...
            <TabPanel value={tabValue} index={0}>
              <Card className={classes.sectionCard}>
                <CardContent>
                  ...
                  <Typography variant="body1" paragraph>Ajuste preferências globais do sistema, notificações e personalizações.</Typography>
                  <Alert severity="info"><strong>Dica:</strong> Revise configurações periodicamente para otimizar uso</Alert>
                </CardContent>
              </Card>
            </TabPanel>
...
export default ConfiguracoesTutorial;
