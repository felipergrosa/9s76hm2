              ...
              <Card className={classes.sectionCard}>
                <CardContent>
                  <Typography variant="h4" gutterBottom>
                    <Memory style={{ marginRight: 8, verticalAlign: "middle" }} />
                    Prompts IA
                  </Typography>
                  <Typography variant="body1" paragraph>Configure prompts personalizados para direcionar comportamento da IA.</Typography>
                  <Alert severity="info"><strong>Dica:</strong> Seja específico e claro nos prompts para melhores resultados</Alert>
                </CardContent>
              </Card>
            </TabPanel>
...
export default PromptsIATutorial;
