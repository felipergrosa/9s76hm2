      ...
      <Card className={classes.sectionCard}>
        <CardContent>
          ...
          <Typography variant="body1" paragraph>
            O Bot agora vai além de apenas conversar - ele{" "}
            <strong>EXECUTA AÇÕES REAIS</strong> usando a tecnologia de{" "}
            <strong>Function Calling</strong> (OpenAI/Gemini). Ao invés de
            apenas prometer "vou enviar o catálogo", o bot ENVIA o arquivo
            automaticamente!
          </Typography>
          ...
          <div className={classes.successBox}>
            ...
            <Typography variant="body2">
              <strong>ANTES:</strong> "Vou te enviar o catálogo..." → Cliente:
              "Cadê?" → Loop infinito
              <br />
              <strong>AGORA:</strong> "Vou te enviar o catálogo..." → [ENVIA
              PDF] → Cliente satisfeito ✅
            </Typography>
          </div>
          ...
          <Box mt={3}>
            <Alert severity="info">
              <strong>5 Funções Disponíveis:</strong> enviar_catalogo,
              enviar_tabela_precos, buscar_produto_detalhado,
              transferir_para_vendedor_responsavel, transferir_para_atendente
            </Alert>
          </Box>
        </CardContent>
      </Card>
      ...
      <Card className={classes.sectionCard}>
        <CardContent>
          ...
          <div className={classes.flowDiagram}>
            ...
            >
              📱 Cliente → 🤖 Bot (IA) → ⚙️ Detecta Função → 🎬 Executa Ação →
              📨 Confirma
            </Typography>
          </div>
...
✅ Chama: enviar_catalogo("completo")`}
                  </div>
                </CardContent>
              </Card>
            </Grid>
          ...
          <Card className={classes.stepCard}>
            <CardContent>
              ...
              <Typography variant="body2" paragraph>
                Configure os arquivos que o bot pode enviar (catálogo, tabelas,
                etc.)
              </Typography>
              <List dense>
                <ListItem>
              ...
              <Alert severity="warning" style={{ marginTop: 16 }}>
                <strong>Importante:</strong> As palavras-chave definem quando o
                arquivo é enviado. Use "catalogo" para catálogos,
                "tabela,precos" para tabelas de preço.
              </Alert>
            </CardContent>
          </Card>
...
→ Bot transfere automaticamente para Bruna!`}
              </div>
            </CardContent>
          </Card>
              ...
              <Box>
                ...
                <List dense>
                  <ListItem>
                    ...
                    <ListItemText
                      primary="Arquivo vinculado à fila?"
                      secondary="Filas → Lista de Arquivos"
                    />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
                    ...
                    <ListItemText
                      primary="Palavras-chave corretas?"
                      secondary='Use "catalogo", não "catologo"'
                    />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
                    ...
                    <ListItemText
                      primary="Arquivo existe no servidor?"
                      secondary="Verificar caminho do arquivo"
                    />
                  </ListItem>
                </List>
                <Alert severity="info">
                  <strong>Logs:</strong> Veja console do backend procurando por
                  "[ActionExecutor]"
                </Alert>
              </Box>
            </AccordionDetails>
              ...
              <Box>
                ...
                <List dense>
                  <ListItem>
                    ...
                    <ListItemText
                      primary="Cliente tem tag pessoal (#)?"
                      secondary="Contatos → Tags"
                    />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
                    ...
                    <ListItemText
                      primary="Vendedor tem permissão?"
                      secondary="Usuários → allowedContactTags"
                    />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
                    ...
                    <ListItemText
                      primary="IDs das tags coincidem?"
                      secondary="Ver nos logs: [ActionExecutor]"
                    />
                  </ListItem>
                </List>
                <div className={classes.codeBlock}>
            ...
            <AccordionDetails>
              <Box>
                ...
                <Alert severity="warning">
                  Modelos antigos (gpt-3.5-turbo) podem não suportar function
                  calling adequadamente
                </Alert>
              </Box>
            </AccordionDetails>
          </Accordion>
