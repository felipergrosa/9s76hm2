        ...
        <MainHeader>
          <Title>
            <span>
              ...
              <strong>Arquivos Chatbot</strong>
            </span>
          </Title>
            ...
            <TabPanel value={tabValue} index={0}>
              <Card className={classes.sectionCard}>
                <CardContent>
                  ...
                  <Typography variant="body1" paragraph>Gerencie arquivos (PDFs, imagens, vídeos) para envio automático pelo bot.</Typography>
                  <Alert severity="info"><strong>Dica:</strong> Organize arquivos por categorias para facilitar localização</Alert>
                </CardContent>
              </Card>
            </TabPanel>
...
export default ArquivosChatbotTutorial;
