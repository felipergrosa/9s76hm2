              ...
              <Card className={classes.sectionCard}>
                <CardContent>
                  <Typography variant="h4" gutterBottom>
                    <FormatListBulleted style={{ marginRight: 8, verticalAlign: "middle" }} />
                    Fila Chatbot
                  </Typography>
                  <Typography variant="body1" paragraph>Configure filas de atendimento com prioridades e distribuição automática.</Typography>
                  <Alert severity="info"><strong>Dica:</strong> Defina horários de funcionamento para cada fila</Alert>
                </CardContent>
              </Card>
            </TabPanel>
...
export default FilaChatbotTutorial;
