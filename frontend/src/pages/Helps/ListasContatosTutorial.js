              ...
              <Card className={classes.sectionCard}>
                <CardContent>
                  <Typography variant="h4" gutterBottom>
                    <ListIcon style={{ marginRight: 8, verticalAlign: "middle" }} />
                    Listas de Contatos
                  </Typography>
                  <Typography variant="body1" paragraph>Crie e gerencie listas segmentadas para campanhas e envios direcionados.</Typography>
                  <Alert severity="info"><strong>Dica:</strong> Atualize listas regularmente para manter base limpa</Alert>
                </CardContent>
              </Card>
            </TabPanel>
...
export default ListasContatosTutorial;
