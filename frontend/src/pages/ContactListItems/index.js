                    ...
                    <table className="w-full table-auto text-sm text-left text-gray-500 dark:text-gray-400">
                      ...
                      <tbody>
                        {sortedContacts.map((contact) => {
                          ...
                          return (
                            <tr key={contact.id} className={`border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 ${isUnlinked ? 'bg-red-50 dark:bg-red-900/20 border-l-4 border-l-red-500' : 'bg-white dark:bg-gray-800'}`}>
                              ...
                              <td className="px-3 py-2 text-center w-[110px]">
                                <Tooltip {...CustomTooltipProps} title={(contact.contact && contact.contact.situation) || ""}>
                                  <span className={`px-1.5 py-0.5 text-xs font-semibold rounded-full ${(contact.contact?.situation || '').toLowerCase() === 'ativo'
