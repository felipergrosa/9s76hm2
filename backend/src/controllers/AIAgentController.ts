...
const createSchema = Yup.object().shape({
    ...
    startDelaySeconds: Yup.number().nullable().min(0),
    startDelayJitterSeconds: Yup.number().nullable().min(0),
    antiBotTraitsRegex: Yup.string().nullable(),
    maxBotLoopMessages: Yup.number().nullable().min(1),
    requireHistoryForAI: Yup.boolean().nullable(),
