...
const createSchema = Yup.object().shape({
    ...
    responseLength: Yup.string(),
    language: Yup.string(),
    brandVoice: Yup.string(),
    allowedVariables: Yup.string(),
    voiceType: Yup.string().oneOf(["text", "generated", "enabled"]),
    voiceApiKey: Yup.string(),
    voiceRegion: Yup.string(),
...
const updateSchema = Yup.object().shape({
    ...
    toneStyle: Yup.string(),
    emojiUsage: Yup.string(),
    hashtagUsage: Yup.string(),
    responseLength: Yup.string(),
    language: Yup.string(),
    brandVoice: Yup.string(),
    allowedVariables: Yup.string(),
